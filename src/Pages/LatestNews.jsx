        ...
        <div className="w-[860px] flex flex-col justify-start items-start bg-white p-5 rounded-md">
          ...
          <Link to={`/card/${id}`} className="card flex w-[820px] gap-5 pt-[20px] border-b pb-[20px]">
            <div className="flex flex-col">
              <p className="font-bold text-[24px] text-[#1D3068]">Спортда бошланғич синф дарсликлари вазни 300 граммдан оширилмаслиги белгилаб қўйилди</p>
              <div className="flex gap-3 pt-3">
                <p className="text-[#E50029]">Спорт</p>
                <p className="text-[#A9AABC]">2 кун олдин</p>
              </div>
            </div>
            <img src={footballer} alt="" className="h-[86px]"/>
          </Link>
          <Link to={`/card/${id}`} className="card flex w-[820px] gap-5 pt-[20px] border-b pb-[20px]">
            <div className="flex flex-col">
              <p className="font-bold text-[24px] text-[#1D3068]">Спортда бошланғич синф дарсликлари вазни 300 граммдан оширилмаслиги белгилаб қўйилди</p>
          ...
          <a href="/#" className="w-full py-[14px] flex items-center justify-center rounded-md mt-3 bg-[#F8F8FF]">Яна юклаш</a>
          </div>
        </div>
      </div>
    </div>
